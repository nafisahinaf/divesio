...
@section('section')
    ...
    <section class="section-gap info-area ">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <input type="text" id="inputName" name="name" class="form-control mb-3" placeholder="Full Name" required autofocus>
            ...
            <input type="password" id="inputPassword" name="confirmPassword" class="form-control" placeholder="Password" required> --}}
