...
<head>
    ...
    <title>Open Water Diver PADI Courses with Ecodive Bali Diving</title>
...
<body>
    ...
    <section class="section-gap-detaildivecenter info-area " id="artikel ">
        <div class="container ">
            <div class="row d-flex justify-content-center ">
                <div class="col">
                    <p>Dive Center Tulamben</p>
                    <h2 class="title-biru">Open Water Diver PADI Courses with Ecodive Bali Diving</h2><br>
                    <hr>
                    <div class="row">
                        <div class="col">
                            <h4 class="title-biru">Mulai dari</h4>
                        </div>
                        <div class="col">
                            <h3 class="title-kuning text-right">IDR 500.000</h3>
                        </div>
                    </div>
                    <hr>
                </div>
    ...
    <script>
        $('#detailpaket-list a').on('click', function(e) {
            e.preventDefault()
            $(this).tab('show')
        })
    </script>
